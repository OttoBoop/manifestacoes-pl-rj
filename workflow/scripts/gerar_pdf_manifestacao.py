#!/usr/bin/env python3
"""
gerar_pdf_manifestacao.py — Converte .md de manifestação técnica para PDF de 1 página.

Especificação: Times New Roman 12pt, espaçamento 1.5, margens 2.5cm, A4.
Validado: ~350 palavras cabem em 1 página com essa configuração.

Uso:
    python gerar_pdf_manifestacao.py --input manifestacao.md
    python gerar_pdf_manifestacao.py --input manifestacao.md --output saida.pdf
...
parser = argparse.ArgumentParser(description="Gera PDF de manifestação técnica a partir de .md")
