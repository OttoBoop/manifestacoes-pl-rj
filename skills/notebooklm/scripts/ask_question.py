...
def ask_notebooklm(question: str, notebook_url: str, headless: bool = True) -> str:
    ...
    try:
        ...
        # Dismiss any open modals/overlays (onboarding dialogs, etc.)
        try:
            overlay = page.query_selector('.cdk-overlay-container [mat-dialog-close], .cdk-overlay-container button.mat-mdc-button, .cdk-overlay-container button')
            if overlay:
        ...
        # Use primary selector for typing — force=True bypasses overlay intercept
